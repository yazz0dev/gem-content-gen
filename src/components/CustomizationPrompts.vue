  ...
  <div class="p-4 border rounded shadow-sm bg-white mb-4">
    ...
    <div class="mb-3">
      ...
      <div class="form-check">
        <input type="radio" id="custom-prompt" name="customizationPrompt" value="custom"
          v-model="selectedPrompt" class="form-check-input">
    ...
    <button @click="applyPrompt" :disabled="!selectedPrompt"
...
export default {
  ...
  methods: {
    ...
    clearPrompt() {
      ...
      this.$emit('prompt-cleared'); // Emit an event when the prompt is cleared
    },
  },
};
</script>
