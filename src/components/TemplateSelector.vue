// /src/components/TemplateSelector.vue (Complete and Correct)
<template>
  <div class="mb-4">
    ...
    <div class="row">
      <div v-for="(template, index) in templates" :key="index"
        ...
        :class="{
          'border-2': true,
          'border-primary': selectedTemplate === template.name,  // Use Bootstrap's 'border-primary'
...
export default {
  ...
  data() {
    return {
      templates: [
        { name: 'Template 1', image: 'https://via.placeholder.com/150' },  // Replace with actual image URLs
        { name: 'Template 2', image: 'https://via.placeholder.com/150' },  // Replace with actual image URLs
