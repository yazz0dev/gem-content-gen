            ...
            <table class="leaderboard-table">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="text-center" colspan="3">Usage</th> <th scope="col" class="text-center">Available
                        </th>
                    </tr>
                    <tr>
                        <th></th>
                ...
                <tbody>
                    <tr v-for="model in leaderboardData" :key="model.id"
                        :class="{ 'unavailable-row': !model.isAvailable }">
                        <td class="model-name">
                            {{ model.id }}
        ...
        setup() {
          ...
          const fetchData = async () => {
            try {
              ...
              console.error("Failed to fetch leaderboard or check rate limits:", err);
          ...
          const authListener = auth.onAuthStateChanged(fetchData);
...
<style scoped>
    ...
    .leaderboard-table {
        ...
        margin-bottom: 0;
        /* Remove default Bootstrap table margin */
    }
    ...
    .unavailable-row {
        opacity: 0.6;
        /* Make unavailable rows less prominent */
    }
